...
--------------------------------------------*/	  
	$(".qtyDpt").append('<div id="decqtybutton" class="dec qtybutton">-</div><div id="incqtybutton" class="inc qtybutton">+</div>');
	$("#decqtybutton").on("click", function() {
		var $button = $(this);
	...
	$("#incqtybutton").on("click", function () {
		var $button = $(this);
		var oldValue = $button.parent().find("input").val();
		if ($button.text() == "+") {
			var newVal = parseFloat(oldValue) + 1;
